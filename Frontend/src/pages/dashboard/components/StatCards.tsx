...
export function StatCards({ t, isDark, stats }: StatCardsProps) {
  const cards = [
    ...
    { label: "Open Issues",      value: stats ? Math.max(stats.totalComplaints - stats.resolved - stats.rejected, 0) : 0, suffix: "",  pct: "live", icon: Zap,          color: "#8B5CF6", bg: isDark?"rgba(139,92,246,0.15)":"#F5F3FF", data: [10,14,12,18,22,28,34] },
